...
public class Charmander extends Pokemon{
    ...
    public String DosyaYolu="src//image//charmander.jpg";
    public ImageIcon icon = new ImageIcon("src//image//charmander.jpg");
    public String getDosyaYolu() {
        return DosyaYolu;
    }
   
    public Charmander(){}
    public Charmander(String Id,String Ad,String Tip){
    super(Id,Ad,Tip);
    }
